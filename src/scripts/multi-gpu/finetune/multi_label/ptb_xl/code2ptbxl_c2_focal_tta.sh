#!/bin/bash
# CODE-backbone -> PTB-XL fine-tune | thesis Small, two-lead II+V2 | Config 2: Focal + TTA
#SBATCH --account=def-majidk
#SBATCH --job-name=c2p_c2_ft
#SBATCH --nodes=1
...
#SBATCH --output=logs/patch_ecg_code2ptbxl_ii_v2_c2_focal_tta-%j.out
set -uo pipefail
...
torchrun --standalone --nproc_per_node=1 -m src.patchECG_finetune \
    ...
    --model_name=patch_ecg_code2ptbxl_ii_v2_c2_focal_tta
