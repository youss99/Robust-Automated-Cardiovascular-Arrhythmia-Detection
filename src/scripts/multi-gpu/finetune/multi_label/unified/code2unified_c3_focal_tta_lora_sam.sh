#!/bin/bash
# CODE-backbone -> Unified fine-tune | thesis Small, two-lead II+V2 | Config 3: Focal+TTA+LoRA+SAM
#SBATCH --account=def-majidk
#SBATCH --job-name=c2u_c3_full
#SBATCH --nodes=1
...
#SBATCH --output=logs/patch_ecg_code2unified_ii_v2_c3_focal_tta_lora_sam-%j.out
set -uo pipefail
...
torchrun --standalone --nproc_per_node=1 -m src.patchECG_finetune \
    ...
    --model_name=patch_ecg_code2unified_ii_v2_c3_focal_tta_lora_sam
