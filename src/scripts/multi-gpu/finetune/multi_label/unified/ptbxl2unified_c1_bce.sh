#!/bin/bash
# PTB-XL-backbone -> Unified fine-tune | thesis Small, two-lead II+V2 | Config 1: BCE
#SBATCH --account=def-majidk
#SBATCH --job-name=p2u_c1_bce
#SBATCH --nodes=1
...
#SBATCH --output=logs/patch_ecg_ptbxl2unified_ii_v2_c1_bce-%j.out
set -uo pipefail
...
torchrun --standalone --nproc_per_node=1 -m src.patchECG_finetune \
    ...
    --model_name=patch_ecg_ptbxl2unified_ii_v2_c1_bce
